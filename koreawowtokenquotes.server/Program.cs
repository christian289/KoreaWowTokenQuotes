...
if (app.Environment.IsDevelopment())
{
    ...
    // app.UseSwaggerUI(c =>
    // {
    //     c.SwaggerEndpoint("/swagger/v1/swagger.json", "wow-api-server API V1");
    // });
}
app.UseHttpsRedirection();

app.MapGet("/api/tokenindex", async ([FromServices] IHttpClientFactory httpClientFactory, ITokenService tokenService) =>
{
    try
    {
